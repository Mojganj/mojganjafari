  ...
  return (
    ...
    >
      ...
      >
        ...
        I&apos;m a dedicated{" "}
        <span className="text-AAsecondary">front-end developer</span> passionate
        about crafting captivating digital experiences. With expertise in{" "}
        <span className="text-AAsecondary">HTML</span>,{" "}
        <span className="text-AAsecondary">CSS</span>, and{" "}
        <span className="text-AAsecondary">JavaScript</span>, I specialize in
        transforming design concepts into responsive and interactive websites
        and applications.
      </motion.h3>
      <motion.div
        initial={{ y: 10, opacity: 0 }}
